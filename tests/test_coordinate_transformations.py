...
from hmc_utils.coordinate_transformations import (cartesian_to_cylindrical,
                                                  cylindrical_to_cartesian,
                                                  cartesian_to_spherical, spherical_to_cartesian,
                                                  latitude_to_colatitude, colatitude_to_latitude)
...
def test_cartensian_to_cylindrical():
    ...
    for argument, expected_result in input_arguments_and_expected_result:
        ...
        expected_result_deg = [degrees(t) if i == 1 else t for i, t in enumerate(expected_result)]
        assert_almost_equal([result], [expected_result_deg])

    # test array like result a well
    input_arguments = input_arguments_and_expected_result[:, 0, :]  # select the input arguments
    output_arguments = input_arguments_and_expected_result[:, 1, :]  # select the output arguments
    xx, yy, zz = input_arguments[:, 0], input_arguments[:, 1], input_arguments[:, 2]
    rr_e, tt_e, zzc_e = output_arguments[:, 0], output_arguments[:, 1], output_arguments[:, 2]
...
def test_cylindrical_to_cartesian():
    ...
    for argument, expected_result in input_arguments_and_expected_result:
        ...
        result = cylindrical_to_cartesian(argument_deg[0], argument_deg[1], argument_deg[2],
                                          degrees=True)
        assert_almost_equal([result], [expected_result])
    ...
    xx_e, yy_e, zz_e = output_arguments[:, 0], output_arguments[:, 1], output_arguments[:, 2]
...
def test_cartesian_to_spherical():
    ...
    for argument, expected_result in input_arguments_and_expected_result:
        ...
        # test for degrees as well
        result = cartesian_to_spherical(argument[0], argument[1], argument[2], degrees=True)
        expected_result_deg = [degrees(t) if i > 0 else t for i, t in enumerate(expected_result)]
        assert_almost_equal([result], [expected_result_deg])
    ...
    output_arguments = input_arguments_and_expected_result[:, 1, :]  # select the output arguments
    xx, yy, zz = input_arguments[:, 0], input_arguments[:, 1], input_arguments[:, 2]
    rr_e, tt_e, pp_e = output_arguments[:, 0], output_arguments[:, 1], output_arguments[:, 2]
...
def test_spherical_to_cartesian():
    ...
    for argument, expected_result in input_arguments_and_expected_result:
        ...
        result = spherical_to_cartesian(argument_deg[0], argument_deg[1], argument_deg[2],
                                        degrees=True)
        assert_almost_equal([result], [expected_result])
    ...
    xx, yy, zz = spherical_to_cartesian(rr, np.rad2deg(tt), np.rad2deg(pp), degrees=True)
    assert_almost_equal([xx], [xx_e])
    assert_almost_equal([yy], [yy_e])
    assert_almost_equal([zz], [zz_e])
